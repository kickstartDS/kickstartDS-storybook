    ...
    <Section spaceBefore="small" background="accent" width="default">
      <div className="template template--concierge">
        <div className="template__main">
          ...
          {status.code !== "canthelp" && status.code !== "error" && answer && (
          ...
          {status.code === "error" && (
            ...
            >
              ...
              <ul>
                ...
                <li>
                  Or maybe your question didn't yield any relevant sections from
                  our knowledge base. Feel free to let us know below to fix
                  this!
                </li>
              </ul>
          ...
          >
            ...
            <span>
              Concierge is not a specialist when it comes to details, so always
              check and verify! Remember: your typical concierge in a hotel
              tries his best... but he's no expert, either! That's why we
              provide the sources the answer given was based on below.
            </span>
            <br />
            <br />
