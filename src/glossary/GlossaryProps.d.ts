 ...
 */
export declare type Definition = string;
/**
 * Url to main image for this glossary entry
 */
export declare type UrlForTheMainImage = string;
/**
 * Title of the term being defined
 */
export declare type CaptionForTheMainImage = string;
/**
 * Select a media asset for this glossary entry
 */
export declare type UrlForTheMediaAsset = string;
/**
 * Title of the term being defined
 */
export declare type CaptionForTheMainImage1 = string;
/**
 * Media assets to display for this glossary entry
 */
export declare type Media = MediaAsset[];
/**
 * Name of the tag
 */
 ...
 */
export declare type Excerpt = string;
/**
 ...
 */
export declare type RelatedEntries = RelatedEntry[];
/**
 * Link to the related StacKShare discussion
 */
export declare type StackShareUrl = string;
/**
