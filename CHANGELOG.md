# v1.13.23 (Thu Apr 14 2022)

#### 🐛 Bug Fix

- fix: force a change [#69](https://github.com/kickstartDS/kickstartDS-storybook/pull/69) ([@julrich](https://github.com/julrich))
...
- fix: use absolute image paths in css ([@lmestel](https://github.com/lmestel))
...
- Merge branch 'master' of https://github.com/kickstartDS/kickstartDS-storybook ([@fleven-kds](https://github.com/fleven-kds))
- feat: customize main button ([@fleven-kds](https://github.com/fleven-kds))
...
- feat: adjust spacings ([@fleven-kds](https://github.com/fleven-kds))
- feat: adjust line height + customize teaser border tokens ([@fleven-kds](https://github.com/fleven-kds))
...
- ci: fix website trigger ([@lmestel](https://github.com/lmestel))
...
- style: format circleci config ([@lmestel](https://github.com/lmestel))
...
# v1.0.15 (Wed Jul 14 2021)

#### ⚠️ Pushed to `master`

- Merge branch 'master' of https://github.com/kickstartDS/kickstartDS-storybook ([@fleven-kds](https://github.com/fleven-kds))
- feat: adjust teaser hover ([@fleven-kds](https://github.com/fleven-kds))
...
- Merge branch 'master' of https://github.com/kickstartDS/kickstartDS-storybook ([@fleven-kds](https://github.com/fleven-kds))
- feat: move teaser styles to seperate page ([@fleven-kds](https://github.com/fleven-kds))
...
# v1.0.12 (Tue Jul 13 2021)

#### ⚠️ Pushed to `master`

- Merge branch 'master' of https://github.com/kickstartDS/kickstartDS-storybook ([@fleven-kds](https://github.com/fleven-kds))
- feat: add teaser variants ([@fleven-kds](https://github.com/fleven-kds))
...
- Merge branch 'master' of github.com:kickstartDS/kickstartDS-storybook ([@julrich](https://github.com/julrich))
- fix: remove storytelling component for now ([@julrich](https://github.com/julrich))
...
- build: update storybook html addon ([@lmestel](https://github.com/lmestel))
- Merge branch 'master' of github.com:kickstartDS/kickstartds-storybook ([@lmestel](https://github.com/lmestel))
- ci: deploy storybook ([@lmestel](https://github.com/lmestel))
- build: add auto release ([@lmestel](https://github.com/lmestel))
- Add .circleci/config.yml ([@lmestel](https://github.com/lmestel))
- build: prepare for ci release ([@lmestel](https://github.com/lmestel))
- refactor: simplify stories ([@lmestel](https://github.com/lmestel))
- build: remove husky ([@lmestel](https://github.com/lmestel))
- chore: add .nvmrc ([@lmestel](https://github.com/lmestel))
